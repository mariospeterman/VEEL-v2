    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_120px_160px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">KYB {organization.kybState ?? "not_started"}</p>
        </div>
        <Fact label="State" value={organization.state} />
        <Fact label="Finance" value="no custody" />
      </div>
      <form action={updateOrganizationKybAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[150px_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_120px_160px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{member.userId}</p>
        </div>
        <Fact label="State" value={member.state} />
        <Fact label="Social rank" value="not for sale" />
      </div>
      <form action={updateOrganizationMemberAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[130px_130px_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_130px_180px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{policy.organizationId}</p>
        </div>
        <Fact label="State" value={policy.state} />
        <Fact label="Boundary" value="software SLA only" />
      </div>
      <form action={updateSupportPolicyAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[150px_150px_150px_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_130px_180px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{supportCase.subjectType}</p>
        </div>
        <Fact label="State" value={supportCase.state} />
        <Fact label="Priority" value={supportCase.priority} />
      </div>
      <form action={updateSupportCaseAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[150px_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_130px_190px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{dispute.paymentIntentId}</p>
        </div>
        <Fact label="State" value={dispute.state} />
        <Fact label="Boundary" value="no custody" />
      </div>
      <form action={updateRefundDisputeAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[190px_1fr_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="grid gap-3 md:grid-cols-[1fr_130px_190px]">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{request.requesterUserId}</p>
        </div>
        <Fact label="State" value={request.state} />
        <Fact label="Boundary" value="minimized" />
      </div>
      <form action={updateDataRequestAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3 sm:grid-cols-[150px_1fr_auto]">
    ...
    <article className="rounded border border-(--line) bg-(--background) p-3 text-sm">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-(--muted)">{flag.category}</p>
        </div>
      ...
      <form action={updateFeatureFlagAction} className="mt-3 grid gap-2 border-t border-(--line) pt-3">
  ...
  return (
    <article className="grid gap-3 rounded border border-(--line) bg-(--background) p-3 text-sm md:grid-cols-[1fr_130px_190px]">
      <div className="min-w-0">
        ...
        <p className="mt-1 truncate text-(--muted)">{program.priority}</p>
      </div>
  ...
  return (
    <article className="grid gap-3 rounded border border-(--line) bg-(--background) p-3 text-sm md:grid-cols-[1fr_130px_190px]">
      <div className="min-w-0">
        ...
        <p className="mt-1 truncate text-(--muted)">{campaign.partnerName}</p>
      </div>
  ...
  return (
    <article className="grid gap-3 rounded border border-(--line) bg-(--background) p-3 text-sm md:grid-cols-[1fr_130px_190px]">
      <div className="min-w-0">
        ...
        <p className="mt-1 truncate text-(--muted)">{waiver.subjectType}</p>
      </div>
