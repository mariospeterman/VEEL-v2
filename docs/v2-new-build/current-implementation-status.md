...
- Media creation has backend draft, upload-session handoff, and TUS browser upload/resume wiring; it still needs provider-ready plus moderation-pending separation, publish action, entitlement-aware playback, and abuse quota enforcement.
