...
3. Continue Supabase onboarding beyond `/enter`: backend app-access shell gating now that session/profile/external-wallet/age-session browser handoffs exist.
