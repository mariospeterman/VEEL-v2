...
- Supabase/Auth session verification boundary, web SSR cookie refresh/confirmation route, real `/enter` magic-link session UX, configured-session redirects for protected web pages, and backend session/profile readiness projections.
