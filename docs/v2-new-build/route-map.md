...
| Memberships | `GET /v1/subscriptions/plans`, `POST /v1/subscriptions/intents`, `POST /v1/subscriptions/authorizations/:id/submissions`, `PATCH /v1/subscriptions/:id/cancel` | Phase 2 | Compatibility route family for platform plans and Creator Memberships using delegated Solana authorization, backend verification, recurring collection, and cancel/revoke state. Target copy says Memberships. |
