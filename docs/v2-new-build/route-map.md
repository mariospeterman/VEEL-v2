...
| Messages | `GET /v1/messages/conversations`, `POST /v1/messages/conversations`, `PATCH /v1/messages/conversations/:id/request`, `PATCH /v1/messages/conversations/:id/read`, `PATCH /v1/messages/conversations/:id/mute`, `GET /v1/messages/conversations/:id/messages`, `POST /v1/messages/conversations/:id/messages`, `PUT /v1/messages/conversations/:id/messages/:messageId/reactions/:reactionKey`, `DELETE /v1/messages/conversations/:id/messages/:messageId/reactions/:reactionKey`, `POST /v1/messages/conversations/:id/paid-message-intents` | Phase 2 | Direct-message requests allow one introduction before recipient consent; acceptance gates read cursors and any legacy paid-message purchase. Participant-scoped replies, content shares, reactions, and notification muting remain backend-authorized. |
