...
| Event Access | `POST /v1/events`, `PATCH /v1/events/:id`, `GET /v1/events/:id`, `POST /v1/events/:id/access-passes/intents`, `POST /v1/events/:id/access-passes/requests`, `POST /v1/access-passes/:id/check-in`, deprecated compatibility aliases `POST /v1/events/:id/tickets/intents`, `POST /v1/events/:id/tickets/requests`, `POST /v1/tickets/:id/check-in` | Phase 3 | Canonical Event Access Pass route family. Pass price creator-owned, backend-validated; ticket-named routes are deprecated compatibility only. |
| Mutuals | `POST /v1/mutuals/activate`, `PATCH /v1/mutuals/preferences`, `GET /v1/mutuals/feed`, `POST /v1/mutuals/interests`, `GET /v1/mutuals`, `PATCH /v1/mutuals/:id/archive`, deprecated compatibility aliases `POST /v1/dating/activate`, `PATCH /v1/dating/preferences`, `GET /v1/dating/feed`, `POST /v1/dating/swipes`, `GET /v1/dating/matches`, `PATCH /v1/dating/matches/:id/archive` | Phase 4 | Canonical Mutuals route family. Explicit opt-in, safety, active-Mutual cap; compatibility aliases must not appear in launch-facing frontend calls or copy. |
| Activity | `GET /v1/activity`, `GET /v1/activity/payments`, `GET /v1/activity/wallet-transactions`, `GET /v1/activity/access-passes`, deprecated compatibility alias `GET /v1/activity/tickets`, `GET /v1/activity/referrals` | Phase 2 | Trust/accountability surface with backend-observed wallet transactions, receipts, passes, not wallet UI proof. |
