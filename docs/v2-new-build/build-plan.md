...
| 08 | Recurring platform subscriptions and creator memberships | Active on `codex/launch-08-recurring-memberships`; official recurring-delegation verification, renewal, cancellation/revocation, creator offer setup, recovery, operations, and consumer UX are the slice boundary. |
