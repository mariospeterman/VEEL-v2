...
| Convergence 06 | Consumer social experience | Merged through PR #94 at `21f06d2`: one accessible action rail, comments sheet, replies, comment likes, mentions, internal shares, hashtags, polls, genuine search/discovery, privacy self-service, and responsive PWA UX; provider staging remains fail closed on recorded external gates |
