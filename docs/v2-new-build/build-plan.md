...
| 03A | SFW media publishing and moderation | Active on `codex/launch-03-sfw-publish-moderation`; ordinary SFW rights declarations reuse the existing performer relation where consent is required, while adult publishing and documentary performer verification remain separately gated and fail-closed |
