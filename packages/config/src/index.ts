...
export const serverEnvSchema = z.object({
  ...
  API_RATE_LIMIT_STORE_DRIVER: z.enum(["process_memory", "redis", "external"]).default("process_memory"),
  API_RATE_LIMIT_REDIS_URL: optionalUrlSchema,
  ...
  REALTIME_JWT_PRIVATE_JWK: optionalStringSchema,
  REALTIME_JWT_KEY_ID: optionalStringSchema,
  REALTIME_JWT_ISSUER: optionalUrlSchema,
  REALTIME_JWT_TTL_SECONDS: z.coerce.number().int().min(60).max(900).default(300),
  ...
  PAYMENT_DEFAULT_ASSET: z.enum(["SOL", "USDC"]).default("SOL"),
  PAYMENT_USDC_MINT: optionalStringSchema,
  PAYMENT_USDC_DECIMALS: z.coerce.number().int().min(0).max(18).default(6),
  PAYMENT_SOLANA_FINALITY: z.enum(["confirmed", "finalized"]).default("finalized"),
  PAYMENT_MIN_SUPPORT_SOL_LAMPORTS: z.coerce.number().int().positive().safe().default(1_000_000),
  PAYMENT_MIN_SUPPORT_USDC_ATOMIC: z.coerce.number().int().positive().safe().default(500_000),
  PAYMENT_MIN_CONTENT_UNLOCK_SOL_LAMPORTS: z.coerce.number().int().positive().safe().default(1_000_000),
  PAYMENT_MIN_CONTENT_UNLOCK_USDC_ATOMIC: z.coerce.number().int().positive().safe().default(500_000),
  PAYMENT_MIN_PAID_MESSAGE_SOL_LAMPORTS: z.coerce.number().int().positive().safe().default(10_000_000),
  PAYMENT_MIN_PAID_MESSAGE_USDC_ATOMIC: z.coerce.number().int().positive().safe().default(500_000),
  PAYMENT_MIN_LIVE_PASS_SOL_LAMPORTS: z.coerce.number().int().positive().safe().default(10_000_000),
  PAYMENT_MIN_LIVE_PASS_USDC_ATOMIC: z.coerce.number().int().positive().safe().default(1_000_000),
  PAYMENT_MIN_EVENT_ACCESS_PASS_SOL_LAMPORTS: z.coerce.number().int().positive().safe().default(10_000_000),
  PAYMENT_MIN_EVENT_ACCESS_PASS_USDC_ATOMIC: z.coerce.number().int().positive().safe().default(1_000_000),
  PAYMENT_QUOTE_TTL_SECONDS: z.coerce.number().int().min(60).max(1800).default(900),
  PAYMENT_PLATFORM_FEE_WALLET: optionalStringSchema,
  PAYMENT_PLATFORM_FEE_BPS: z.coerce.number().int().min(0).max(9_999).default(1_000),
  ...
  LIVEPEER_API_BASE_URL: z.string().url().default("https://livepeer.studio/api"),
  ...
  DIDIT_ADULT_PUBLISHER_WORKFLOW_ID: optionalStringSchema,
