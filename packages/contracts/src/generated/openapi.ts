...
export interface paths {
    ...
    "/v1/analytics/query": {
        ...
        get?: never;
        put?: never;
        /** Query versioned privacy-safe metrics through one authorized structured service */
        post: operations["queryAnalytics"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/analytics/health": {
        ...
        /** Inspect projection freshness, retries, reconciliation, and privacy suppression health */
        get: operations["getAdminAnalyticsHealth"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/admin/analytics/jobs": {
        ...
        get?: never;
        put?: never;
        /** Enqueue an audited bounded analytics backfill or reconciliation job */
        post: operations["enqueueAdminAnalyticsJob"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** @enum {string} */
        OnboardingAnalyticsEventKey: "landing_viewed" | "landing_cta_clicked" | "landing_nav_clicked" | "landing_section_viewed" | "landing_money_example_viewed" | "landing_comparison_viewed" | "landing_faq_opened" | "login_opened" | "onboarding_opened" | "auth_method_selected" | "wallet_runtime_ready" | "wallet_authentication_completed" | "wallet_ownership_verified" | "profile_step_viewed" | "profile_step_completed" | "age_step_started" | "age_step_completed" | "age_step_failed" | "protected_app_entered" | "onboarding_abandoned" | "returning_login_completed" | "account_not_found";
        ...
        AnalyticsCreatorScope: {
            /** @constant */
            type: "creator";
            /** Format: uuid */
            creatorUserId?: string;
        };
        AnalyticsViewerScope: {
            /** @constant */
            type: "viewer";
            /** Format: uuid */
            userId?: string;
        };
        AnalyticsOrganizationScope: {
            /** @constant */
            type: "organization";
            /** Format: uuid */
        ...
        AnalyticsDimensions: {
            ...
            creatorUserId?: string;
            /** @enum {string} */
            onboardingEvent?: "landing_viewed" | "landing_cta_clicked" | "landing_nav_clicked" | "landing_section_viewed" | "landing_money_example_viewed" | "landing_comparison_viewed" | "landing_faq_opened" | "login_opened" | "onboarding_opened" | "auth_method_selected" | "wallet_runtime_ready" | "wallet_authentication_completed" | "wallet_ownership_verified" | "profile_step_viewed" | "profile_step_completed" | "age_step_started" | "age_step_completed" | "age_step_failed" | "protected_app_entered" | "onboarding_abandoned" | "returning_login_completed" | "account_not_found";
            /** Format: date */
            cohortStartDate?: string;
        };
        AnalyticsScope: {
            /** @enum {string} */
            type: "viewer" | "creator" | "organization" | "platform";
            /** Format: uuid */
            userId?: string;
            /** Format: uuid */
            creatorUserId?: string;
        ...
        AnalyticsQueryRequest: {
            ...
            metricKeys: components["schemas"]["AnalyticsMetricKey"][];
            window: components["schemas"]["AnalyticsWindow"];
            comparisonWindow?: components["schemas"]["AnalyticsWindow"];
            /** @enum {string} */
            granularity: "day" | "total";
            /** @enum {string} */
            timezone: "UTC";
            dimensions?: components["schemas"]["AnalyticsDimensions"];
        };
        /** @description Ratios are JSON numbers; lossless counts, seconds, and native minor units are decimal strings. */
        AnalyticsScalar: number | string;
        AnalyticsMetricPoint: {
            /** Format: date */
            bucketDate: string | null;
            value: components["schemas"]["AnalyticsScalar"] | null;
        ...
        AnalyticsMetricResult: {
            metricKey: components["schemas"]["AnalyticsMetricKey"];
            definitionVersion: number;
            label: string;
            /** @enum {string} */
            unit: "count" | "seconds" | "ratio" | "minor_units";
            dimensions: components["schemas"]["AnalyticsDimensions"];
            points: components["schemas"]["AnalyticsMetricPoint"][];
            comparisonValue: components["schemas"]["AnalyticsScalar"] | null;
        ...
        AnalyticsInsight: {
            ...
            successMetric: components["schemas"]["AnalyticsMetricKey"];
            /** Format: date-time */
            expiresAt: string;
        };
        AnalyticsQueryResponse: {
            scope: components["schemas"]["AnalyticsScope"];
            window: components["schemas"]["AnalyticsWindow"];
            comparisonWindow: components["schemas"]["AnalyticsWindow"] | null;
            /** @enum {string} */
            granularity: "day" | "total";
            /** @enum {string} */
            timezone: "UTC";
            ...
            metrics: components["schemas"]["AnalyticsMetricResult"][];
...
export interface operations {
    ...
    queryAnalytics: {
        ...
        responses: {
            /** @description Authorized metric objects with explicit freshness and privacy decisions */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    getAdminAnalyticsHealth: {
        ...
        requestBody?: never;
        responses: {
            /** @description Privacy-minimized Analytics Core operations health */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["AnalyticsProjectionHealth"];
                };
            };
            401: components["responses"]["Unauthorized"];
            403: components["responses"]["Forbidden"];
    ...
    enqueueAdminAnalyticsJob: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AnalyticsProjectionJobRequest"];
            };
        };
        responses: {
            /** @description Existing or newly queued bounded analytics job */
            202: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["AnalyticsProjectionJobReceipt"];
                };
            };
            400: components["responses"]["ValidationFailed"];
            401: components["responses"]["Unauthorized"];
